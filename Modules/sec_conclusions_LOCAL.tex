In this work we have suggested a novel approach to beamforming and localization, which is based on generating a continuous feedback between the array and the target of interest.
