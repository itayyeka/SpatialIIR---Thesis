...
\supervisionEnglish{This research was carried out under the supervision of Prof.~Israel Cohen, in the Faculty of Electrical and Computer Engineering and Dr. Tsvi G. Dvorkind from RAFAEL.}
\supervisionHebrew{
המחקר בוצע בהנחייתם של פרופ' ישראל כהן בפקולטה להנדסת חשמל ומחשבים
ודר' צבי דבורקינד מחברת רפאל.
}

\GregorianDateEnglish{January 2021}
...
\GregorianDateHebrew{ינואר \beginL2021\endL}
\JewishDateEnglish{Tevet 5781}
\JewishDateHebrew{טבת התשפ"א}
...
\thesisbibfiles{misc/paperBib.bib,misc/thesisBib.bib}
\thesisbibstyle{plain}
